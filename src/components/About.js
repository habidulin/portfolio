...
const About = () => {
  return (
    <div className="p-8">
      ...
      <p className="text-lg">
        Привет! Меня зовут Maksym, и я разработчик с опытом работы в создании современных веб-приложений.
        Я специализируюсь на React, Tailwind CSS и других современных технологиях.
      </p>
